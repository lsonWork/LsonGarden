                            ...
                            <div class="card-body p-5 text-center">
                                ...
                                <form action="SignupServlet" method="post">
                                    <div class="form-outline mb-4">
                                        <input style="width: 410px; border: 0px; outline: none; margin-bottom: 15px" type="text" name="usernameSignUp" placeholder="Username"/>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input style="width: 410px; border: 0px; outline: none; margin-bottom: 15px" type="password" name="passwordSignUp" placeholder="Password"/>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input style="width: 410px; border: 0px; outline: none; margin-bottom: 15px" type="password" name="reenterSignUp" placeholder="Re-enter Password"/>
                                    </div>

                                    <div class="form-outline" style="margin-bottom: 20px">
                                        <input style="width: 410px; border: 0px; outline: none; margin-bottom: 15px" type="text" name="fullnameSignUp" placeholder="Fullname"/>
                                    </div>
