    ...
    <body>
        ...
        <div style="overflow-y: hidden; width: 100%; position: relative;">
                            ...
                            <div style="display: flex; align-items: center;" class="col-lg-6">
                                <nav class="header__menu">
                                    <ul>
                                        ...
                                        <li class="active"><a href="TemplateContact.jsp">Contact</a></li>
            ...
            <div id="khoibaogomanh">
                <img class="imghiddeny" style="box-shadow: 0 10px 10px rgba(0, 0, 0, 0.2); width: 100%; height: 100%" src="pics/contact.jpg" alt="alt"/>    
            </div>
        </div>
        <!--</div>-->
