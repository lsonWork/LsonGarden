...
public class CoordinateServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        String productsButton = request.getParameter("productsButton");
        String accountsButton = request.getParameter("accountsButton");
        String statisticButton = request.getParameter("statisticButton");
        ...
        if (statisticButton != null) {
            response.sendRedirect("OverallStatisticServlet");
        }
    }
