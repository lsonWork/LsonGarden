...
<html>
    ...
    <body style="overflow-x: hidden; background: #C9D6CC; height: 1000px">
        ...
        <div style="margin-top: 170px; margin-left: 380px">
            <a style="color: black;" href="GoToAdminPage"><i class="fa-solid fa-chevron-left"></i> Back to Product Management</a>
        </div>                        
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <h3 style="font-size: 25px; text-align: center" class="mb-5">Update product in Database</h3>

                                    <div class="form-outline mb-4">
                                        <input type="text" pattern="^[A-Za-z\sÀ-ỹ]+$" id="typePasswordX-2" class="form-control form-control-lg" value="${requestScope.nameToUpdate}" name="newItemName" required/>
                                        <label class="form-label" for="typePasswordX-2">Name</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input type="text" pattern="^[0-9]+$" id="typePasswordX-2" class="form-control form-control-lg" value="${requestScope.priceToUpdate}" name="newItemPrice" required/>
                                        <label class="form-label" for="typePasswordX-2">Price</label>
                                    </div>

                                    <div class="form-outline" style="margin-bottom: 20px">
                                        <select name="newItemType">
                                            <option value="0" ${requestScope.typeToUpdate == 0 ? 'selected' : ''}>Hoa</option>
                                            <option value="1" ${requestScope.typeToUpdate == 1 ? 'selected' : ''}>Cây</option>
                                        </select>
                                    </div>
                                    <br>
                                    <br>
                                    ...
                                    <div class="form-outline" style="margin-bottom: 20px;">
                                        <input type="file" id="typePasswordX-2" class="form-control form-control-lg" name="newItemLink" required/>
