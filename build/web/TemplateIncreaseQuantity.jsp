...
<html>
    ...
    <body style="overflow-x: hidden; background: #C9D6CC; height: 1000px">
        ...
        <div>
            <form action="IncreaseQuantityServlet" method="post">
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <h3 style="font-size: 25px; text-align: center" class="mb-5">Increase quantity of product in Database</h3>

                                    <!--                                    <div class="form-outline mb-4">
                                                                            <input type="text" pattern="^[0-9]+$" id="" class="form-control form-control-lg" value=""/>
                                                                            <label class="form-label" for="typeEmailX-2">ID</label>
                                                                        </div>-->

                                    <input type="hidden" name="idToUpdate2" value="${requestScope.idToUpdate}">
                                    <div class="form-outline" style="margin-bottom: 20px">
                                        <input type="text" pattern="^[0-9]+$" id="typePasswordX-2" class="form-control form-control-lg" value="${requestScope.quantityToUpdate}" name="quantityToUpdate2" required/>
