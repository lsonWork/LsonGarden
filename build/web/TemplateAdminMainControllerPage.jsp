...
<html>
    ...
    <body>
        ...
        <form action="CoordinateServlet" method="post">
            <div style="margin-top: 300px; display: flex; justify-content: space-around">
                <div>
                    <button name="productsButton" value="productsButton" class="nutdieuphoi" type="submit" style="margin-left: 150px; width: 250px; height: 100px; font-size: 20px; border-radius: 40px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);">
                        <i style="color: green" class="fa-solid fa-seedling"></i> Products Management
                    </button>
                </div>
                <% 
                if (checkIsAdmin.equalsIgnoreCase("Admin")) {
                %>
                <div>
                    <button name="accountsButton" value="accountsButton" class="nutdieuphoi" type="submit" style="width: 250px; height: 100px; font-size: 20px; border-radius: 40px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);">
                        <i style="color: red" class="fa-solid fa-user-gear"></i> Accounts Management
                    </button>
                </div>
                <%
                }
                %>
                <div>
                    <button name="statisticButton" value="statisticButton" class="nutdieuphoi" type="submit" style="margin-right: 150px; width: 250px; height: 100px; font-size: 20px; border-radius: 40px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);">
                        <i style="color: gold" class="fa-solid fa-chart-line"></i> Overall Statistic
                    </button>
                </div>
            </div>
        </form>
