...
<html>
    ...
    <body style="overflow-x: hidden; background: #C9D6CC; height: 1000px">
        ...
        <div style="margin-top: 170px; margin-left: 380px">
            <a style="color: black;" href="TemplateAdminPage.jsp"><i class="fa-solid fa-chevron-left"></i> Back to Admin's Page</a>
        </div>                        
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <h3 class="mb-5">Add products into Database</h3>
                                    <div class="form-outline mb-4">
                                        <input type="text" id="typePasswordX-2" class="form-control form-control-lg" name="nameToAdd" required/>
                                        <label class="form-label" for="typePasswordX-2">Name</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input type="text" pattern="^[0-9]+$" id="typePasswordX-2" class="form-control form-control-lg" name="priceToAdd" required/>
                                        <label class="form-label" for="typePasswordX-2">Price</label>
                                    </div>

                                    <div class="form-outline" style="margin-bottom: 20px">
                                        <input type="text" pattern="^[0-9]+$" id="typePasswordX-2" class="form-control form-control-lg" name="quantityToAdd" required/>
                                        <label class="form-label" for="typePasswordX-2">Quantity</label>
                                    </div>
                                    
                                    <div class="form-outline" style="margin-bottom: 20px">
                                        <select name="typeToAdd">
                                            <option value="0">Hoa</option>
                                            <option value="1" selected>Cây</option>
                                        </select>
                                    </div>
                                    <br>
                                    <br>
                                    <br>
                                    <div class="form-outline" style="margin-bottom: 20px">
                                        <input type="file" id="typePasswordX-2" class="form-control form-control-lg" name="linkToAdd" required/>
                                        <label class="form-label" for="typePasswordX-2">Link</label>
                                    </div>
                                    <hr class="my-4">
                                    <button class="btn btn-primary btn-lg btn-block" style="background-color: #236D5E" type="submit">Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
